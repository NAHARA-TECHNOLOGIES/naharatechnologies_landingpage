    ...
    >
      ...
      <div className="relative z-10 text-center text-white px-4 py-20 max-w-4xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <a
            href="#pricing"
            className="bg-[#C41E3A] hover:bg-[#B91C1C] px-8 py-4 rounded-full font-bold text-white transition-all duration-300 hover:scale-105 shadow-lg"
          >
            View All Pricing
          </a>
          <a
            href="#contact"
            className="border-2 border-white text-white hover:bg-white hover:text-black px-8 py-4 rounded-full font-bold transition-all duration-300"
          >
            Get Custom Quote
          </a>
        </div>
