...
const HelpHero = () => {
  return (
    <div className="min-h-[450px] lg:min-h-[786px] justify-center relative help-hero-bg">
      <Overlay className="bg-[#3309099C] inset-0 px-4 sm:px-6 lg:pt-[216px] lg:pb-[280px] flex flex-col justify-center">
        <div className="text-center text-white w-full max-w-[945px] mx-auto">
        ...
        <div className="mt-[46px] w-full max-w-[945px] flex flex-col lg:flex-row justify-between mx-auto">
          <SearchBar
            showIcon={false}
      ...
      {/* <ImageWrap
        source={images.helpHeroBg}
        alt="hero background image"
        containerStyle="absolute inset-0"
        imageStyle="size-full object-cover object-center block"
      /> */}
    </div>
  );
};
