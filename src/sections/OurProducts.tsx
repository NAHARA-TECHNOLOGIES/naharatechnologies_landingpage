  ...
  return (
    <section className="py-28 from-gray-50 to-white dark:from-gray-900 dark:to-gray-800 relative overflow-hidden">
      <div className="container mx-auto px-6 text-center">
        <motion.h2
          className="text-h2 mb-6 text-darkText dark:text-white"
        ...
        <p className="text-bodyDefault text-gray-600 dark:text-gray-300 mb-16 max-w-2xl mx-auto leading-relaxed">
          Transform your ideas into reality with our full-stack solutions,
          digital marketing strategies, and mobile apps. Plus, get a free
          consultation to kickstart your project.
        </p>
          ...
          {products.map((product, index) => (
            <motion.div
              ...
              className={`group relative p-8 rounded-3xl shadow-2xl transition-transform cursor-pointer
                ${
                  product.gradient
                    ? `bg-gradient-to-r ${product.gradient} animate-gradient`
            ...
            >
              ...
              <p
                className={`text-bodySmall leading-relaxed ${
                  product.gradient
                    ? "text-white/90"
