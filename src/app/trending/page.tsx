      ...
      <div className="grid gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
        {trendingPosts.map((post, index) => (
          ...
          >
            <Link
              href={`/post/${post.slug}`}
              className="group relative flex flex-col rounded-2xl overflow-hidden bg-white dark:bg-gray-900 shadow-md hover:shadow-2xl
            ...
            >
              <div className="relative h-56 sm:h-52 md:h-56 lg:h-60 w-full overflow-hidden">
                ...
                <div className="absolute top-3 left-3 bg-red-600 text-white text-xs px-3 py-1 rounded-full font-semibold shadow-md">
                  {post.category}
                </div>
              </div>
              ...
              <div className="flex flex-col justify-between flex-1 p-5">
                <div>
                  <h3 className="text-base sm:text-lg font-bold mb-2 text-gray-900 dark:text-white group-hover:text-red-600 transition-colors line-clamp-2">
                    {post.title}
                  </h3>
