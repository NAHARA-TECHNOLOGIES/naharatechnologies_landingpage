      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        {filteredJobs.map((job) => (
          ...
          >
            ...
            <p className="text-gray-600  dark:text-gray-300 mt-2 text-bodyXS">
              {job.category} | <FiMapPin className="inline text-gray-400 dark:text-gray-300" />{" "}
              {job.location}
            </p>
            <p className="text-gray-700  dark:text-gray-300 mt-2 text-bodySmall">{job.description}</p>
            <button
              className="mt-4 btn-primary px-4 py-2 hover:bg-red-700 w-full rounded-sm"
